...
class AnomifyLiveDetector:
    def __init__(self):
        ...
        # Prefer the modern, version-safe .keras format. Fall back to the
        # legacy .h5 file only if no .keras file has been produced yet.
        keras_path = base_path / "models" / "autoencoder.keras"
        h5_path = base_path / "models" / "autoencoder.h5"
        self.model_path = keras_path if keras_path.exists() else h5_path
